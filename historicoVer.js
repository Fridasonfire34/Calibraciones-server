...
module.exports = (config) => {
    ...
    router.get('/historicoVer', async (req, res) => {
        try {
            ...
            await pool.request().query(`
                ...
                UPDATE E
                SET
                    E.[Ultima Calibracion Ver 6] = H.Fecha,
                    E.[Siguiente Calibracion Ver 6] = DATEADD(DAY, 60, H.Fecha)
                FROM
                    Equipos E
                INNER JOIN (
